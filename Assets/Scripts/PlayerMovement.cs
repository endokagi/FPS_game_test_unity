...
public class PlayerMovement : MonoBehaviour
{
    ...
    //Movement
    public float setMoveSpeed = 2000;
    ...
    private void Movement()
    {
        ...
        rb
            .AddForce(orientation.transform.forward *
            y *
            moveSpeed *
            Time.deltaTime *
            multiplier *
            multiplierV);
        rb
            .AddForce(orientation.transform.right *
            x *
            moveSpeed *
            Time.deltaTime *
            multiplier);
    ...
    private void Look()
    {
        ...
        playerCam.transform.localRotation =
            Quaternion.Euler(xRotation, desiredX, 0);
    ...
    private void CounterMovement(float x, float y, Vector2 mag)
    {
        ...
        if (
            Mathf
                .Sqrt((
                Mathf.Pow(rb.velocity.x, 2) + Mathf.Pow(rb.velocity.z, 2)
                )) >
            maxSpeed
        )
        {
